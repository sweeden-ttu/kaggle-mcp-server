.PHONY: help install run-workbench run-server run-mlsyseng generate-skills test clean build
...
help:
	...
	@echo "  generate-skills - Generate platform skills from skills.yaml"
	@echo "  test            - Run tests"
...
run-mlsyseng:
	...
	PYTHONPATH=src python -m mlsyseng_mcp.server
